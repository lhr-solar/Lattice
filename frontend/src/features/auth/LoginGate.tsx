...
import { latticeFullLogo } from "@/assets/logos";
...
export function LoginGate() {
  ...
  return (
    <div className="flex min-h-screen bg-tesla-bg">
      <aside className="panel-fade-in hidden w-1/2 items-center justify-center border-r border-tesla-border bg-tesla-surface/40 px-12 lg:flex">
        <img
          src={latticeFullLogo}
          alt="Lattice"
      ...
      <main className="flex flex-1 items-center justify-center px-4 py-8">
        ...
        >
          <div className="mb-6 lg:hidden">
            <img src={latticeFullLogo} alt="Lattice" className="mx-auto mb-4 w-full max-w-xs" />
          </div>
          <div className="mb-6">
            <h1 className="text-xl font-semibold tracking-tight text-tesla-text">Sign in</h1>
            <p className="mt-1 text-sm text-tesla-muted">Wire harness topology planning</p>
          </div>
