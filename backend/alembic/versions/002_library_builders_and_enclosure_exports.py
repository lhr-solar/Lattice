...
def upgrade() -> None:
    ...
    if not fk_exists("connector_instances", "fk_connector_instances_source_pcb_instance_id"):
        op.create_foreign_key(
    ...
    if column_exists("connector_templates", "default_is_panel_mount"):
        op.alter_column("connector_templates", "default_is_panel_mount", server_default=None)
    if column_exists("pcb_template_connector_slots", "export_to_enclosure"):
